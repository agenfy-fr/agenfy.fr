    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="pt-20">
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <div className="grid md:grid-cols-3 gap-8">
              {study.results.map((result, index) => (
                <Reveal key={result.label} delay={index * 0.1} className="text-center">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-start">
              <Reveal>
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h2 className="text-h2 font-bold text-foreground">Le Challenge</h2>
                </div>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-start">
              <Reveal>
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h2 className="text-h2 font-bold text-foreground">La Solution</h2>
                </div>
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <Reveal>
              <div className="flex items-center gap-3 mb-8">
                ...
                <h2 className="text-h2 font-bold text-foreground">Mise en œuvre</h2>
              </div>
            </Reveal>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {study.implementation.phases.map((phase, index) => (
                <Reveal key={index} delay={index * 0.1}>
                  <Card className="bg-card/50 border-border/50 relative h-full">
                    <CardContent className="p-6">
        ...
        <section className="py-16 bg-secondary/20">
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <Reveal>
              <h2 className="text-h2 font-bold text-foreground mb-8">Technologies utilisées</h2>
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <Reveal>
              <div className="flex items-center gap-3 mb-8">
                ...
                <h2 className="text-h2 font-bold text-foreground">Ce que nous avons appris</h2>
              </div>
            </Reveal>
        ...
        {relatedStudies.length > 0 && (
          <section className="py-16 bg-secondary/20">
            <div className="max-w-7xl mx-auto px-6 lg:px-8">
              <Reveal>
                <h2 className="text-h2 font-bold text-foreground mb-8">Autres études de cas</h2>
              </Reveal>
              <div className="grid md:grid-cols-2 gap-6">
                {relatedStudies.map((related, index) => (
                  <Reveal key={related.id} delay={index * 0.1}>
                    <Link href={`/etudes-de-cas/${related.id}`} className="group block h-full">
